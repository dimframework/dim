module github.com/nuradiyana/dim/examples/simple

go 1.25.4

require (
	github.com/jackc/pgx/v5 v5.8.0
	github.com/nuradiyana/dim v0.1.0
)

require (
	github.com/atfromhome/goreus v1.1.0 // indirect
...
replace github.com/nuradiyana/dim => ../../
